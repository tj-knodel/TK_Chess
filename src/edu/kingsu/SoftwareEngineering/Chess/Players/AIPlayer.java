...
public class AIPlayer extends Player {
    ...
    public Move getMove(Board board) {
        ...
        System.out.println("The best move for " + ((colour == Team.WHITE_TEAM) ? "White" : "Black") + " is " + bestMove.piece.getPieceName() + " to " + bestMove.end.column + "," + bestMove.end.row);
        System.out.println("The score of this move is "+ bestScore);
        return bestMove;
    }
